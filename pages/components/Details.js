...
function Details() {
  ...
  // const {detail, groupIndex } = router.query;
      ...
      <div className="grid sm:grid-cols-2 border-2 rounded-lg border-stone-300  md:ml-10 m-2 ">
        <div className="m-4 ">
          <div className="m-1 font-bold text-xl">
            {itemsData[groupIndex].desc}
          </div>
          <div className="font-bold m-1">
            {" "}
            Total Price : Rs {detailAll.total}
          </div>

          <div className=" m-1 flex">
            {Array.from({ length: detailAll.avgRating }, (_, i) => (
              <svg
                key={i}
            ...
            {Array.from({ length: 5 - detailAll.avgRating }, (_, i) => (
              <svg
                key={i}
          ...
          <div>
            ...
            >
              {item && (
                <>
                  <Link
                    href={`/moredetails/${item.id}/${itemsArrayString}`}
