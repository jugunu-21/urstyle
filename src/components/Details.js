        ...
        {itemsArray.map((item, index) => (
          <div key={index} className="md:flex  space-x-4 my-4 rounded-lg">
            <img
              ...
              alt=""
            />
            <div className="p-4 ml-6 sm:block    md:flex md:items-center md:justify-center">
              <div className="mb-4">
                <div
              ...
              <Link
                ...
                className=" inline-flex items-center px-10 py-4 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              >
                Read more
                <svg
