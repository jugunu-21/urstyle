  ...
  return (
    ...
    >
      <div className=" py-2 px-2 sm:py-8 sm:px-24 lg:flex ">
        ...
        <div className="lg:w-1/4 md:w-1/2 w-full px-4 py-2  mx-2 rounded-lg">
          ...
          {/* <p className="text-gray-500 text-sm mt-2 md:text-left text-center">   Get exclusive content and offers straight to your inbox.
